    ...
    items: [
      {
        label: 'Développement',
        description:
          'Bien évidemment, $coder$ et créer de nouveaux projets fait grandement partie de mes intérêts, ' +
          "j'aime plus particulièrement la $programmation bas niveau$ et la $conception d'interfaces$.",
      },
      {
        label: 'Électronique',
        description:
          'Bidouiller des $circuits$ et construire des dispositifs électroniques en $autodidacte$. ' +
      ...
      },
      {
        ...
        description:
          ...
          "Cela m'a aidé à saisir les premiers concepts en développement, " +
      ...
      },
      {
        ...
        description:
          ...
          "J'apprends aussi la modélisation pour l'impression 3D.",
      },
      {
        label: 'Vidéos',
        description:
