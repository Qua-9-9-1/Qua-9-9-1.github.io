  ...
  hobbies: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'Playing $video games$ to relax and $challenge myself$. ' +
          'It has helped me grasp the basic concepts of development, ' +
          'It has inspired me a lot to create $my own games$.',
      },
      {
        label: 'Music',
        description:
