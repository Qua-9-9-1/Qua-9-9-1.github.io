export const layout_en = {
  ...
  footer: {
    ...
    credits: {
      ...
      models: {
        title: '3D Models',
        desc: '3D models used in this portfolio are sourced from Sketchfab. Licenses for each model can be found below:',
        license: 'license',
        laptop: 'Laptop',
      ...
      UI: {
        title: 'Icons & UI',
        icons_by: 'Icons by',
        ui_by: 'UI components by',
        _404_by: 'Animated 404 text by',
      },
    },
  },
};
