...
export const skills: Record<string, Skill[]> = {
    DevOps: [
        ...
        { name: "Docker Compose", img: "techs/docker-compose.png", negative: false },
    ...
    Programming: [
        ...
        { name: "TypeScript and Javascript", img: "techs/typescript.png", negative: false },
    ],
    Web: [
